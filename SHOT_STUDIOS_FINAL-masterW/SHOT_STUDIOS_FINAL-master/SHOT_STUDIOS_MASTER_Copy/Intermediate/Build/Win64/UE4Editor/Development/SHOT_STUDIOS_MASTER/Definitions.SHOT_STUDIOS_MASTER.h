...
#define ORIGINAL_FILE_NAME "UE4Editor-SHOT_STUDIOS_MASTER.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME SHOT_STUDIOS_MASTER
#define DEPRECATED_FORGAME DEPRECATED
#define SHOT_STUDIOS_MASTER_API DLLEXPORT
